...
# Construct interrupt mask
        ...
        # SET UP PUZZLE REQUEST LISTENER
        sw $zero, has_puzzle($zero)             # puzzle_received = 0
        lw $t2, has_puzzle($zero)               # store value of puzzle_received in t2
        la $t3, puzzle                          # &puzzle
        sw $t3, REQUEST_PUZZLE($zero)           # *REQUEST_PUZZLE = &puzzle

        # SET UP LOOP MOVEMENT
